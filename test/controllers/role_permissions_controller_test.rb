...
class RolePermissionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create role_permission" do
    assert_difference('RolePermission.count') do
      post role_permissions_url, params: { role_permission: { created_by: @role_permission.created_by, permission_id: @role_permission.permission_id, role_id: @role_permission.role_id, status: @role_permission.status, user_id: @role_permission.user_id } }
    end
  ...
  test "should update role_permission" do
    patch role_permission_url(@role_permission), params: { role_permission: { created_by: @role_permission.created_by, permission_id: @role_permission.permission_id, role_id: @role_permission.role_id, status: @role_permission.status, user_id: @role_permission.user_id } }
